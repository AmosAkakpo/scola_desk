...
const NAV_ITEMS = [
  ...
  { to: '/grades/fiches', label: 'Fiches de notes', icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4', perm: 'grades.view' },
  { to: '/grades/import', label: 'Importer fiches', icon: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12', perm: 'grades.edit' },
